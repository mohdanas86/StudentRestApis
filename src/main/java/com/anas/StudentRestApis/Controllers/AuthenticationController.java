...
public class AuthenticationController {
    ...
    public ResponseEntity<ApiResponse<UserEntityDto>> register(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.error("Registration Error", "An error occurred during registration"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> validateToken(@RequestBody Map<String, String> request) {
        ...
        if (token == null || token.isEmpty()) {
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Invalid token", "Token signature or expiration is invalid"));
        }
